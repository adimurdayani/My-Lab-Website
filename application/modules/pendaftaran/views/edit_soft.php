                ...
                <div class="col-lg">
                    <div class="card">
                        <div class="card-body table-responsive">
                            ...
                            <?= form_open_multipart('pendaftaran/pendaftaran_soft/update') ?>
                            <div class="row">
                                <div class="col-xl-6">
                            ...
                            <div class="row mt-3">
                                <div class="col-12 text-center">
                                    ...
                                    <a href="<?= base_url('pendaftaran/pendaftaran_soft') ?>" class="btn btn-light waves-effect waves-light m-1"><i class="fe-x mr-1"></i> Kembali</a>
                                </div>
                            </div>
