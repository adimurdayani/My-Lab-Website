                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    if (!empty($s)) {
                                        ...
                                        $cetak = $this->db->get('tb_pendaftaran_s')->row();
                                    }
                                    ?>
                                    ...
                                    <?php if (!empty($s)) : ?>
                                        <?php if ($cetak) : ?>
                                            <form action="<?= base_url('pendaftaran/pendaftaran_soft/cetak') ?>" method="post" target="_blank">
                            ...
                            <form action="<?= base_url('pendaftaran/pendaftaran_soft/hapus_all/') ?>" method="POST" id="form-delete">
                                <div class="row p-2">
                                    <div class="col-md-6">
                                        ...
                                        <a href="<?= base_url('pendaftaran/pendaftaran_soft/tambah') ?>" class="btn btn-outline-blue mb-2"><i class="fe-plus"></i> Tambah</a>
                                    </div>
                                </div>
                                <?php
                                ...
                                if (!empty($semester)) :
                                    ...
                                    $get_data = $this->db->get('tb_pendaftaran_s')->result();
                                ?>
