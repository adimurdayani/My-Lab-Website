...
<div class="content-page">
                    ...
                    <div class="card">
                        <div class="card-body table-responsive">
                            ...
                            <div class="form-group">
                                <input type="hidden" name="id" value="<?= $get_informasi['id'] ?>">
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6">
                                    <h4 class="header-title">Tabel Session Jadwal</h4>
                                    <table class="table table-bordered w-100">
                                        ...
                                        <tbody>
                                            <?php $no = 1;
                                            foreach ($get_informasi_session as $data) : ?>
                                                <tr>
                                                    <td><?= $no++ ?></td>
                                ...
                                <div class="col-md-6">
                                    <h4 class="header-title">Tabel Detail Informasi Jadwal</h4>
                                    <table class="table table-bordered w-100">
                                        <thead>
                                            <tr>
                                                <th class="text-center">#</th>
                                                <th class="text-center">Detail Nama Praktikum</th>
                                                <th class="text-center">Detail Tanggal</th>
                                                <th class="text-center">Detail Jam</th>
                                                <th class="text-center">Aksi</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            foreach ($get_informasi_detail as $data) : ?>
                                                <tr>
                                                    ...
                                                    <td><?= $data['jam_praktikum'] ?></td>
                                                    <td>
                                                        <button type="button" data-informasiid="<?= $data['informasi_id'] ?>" class="btn btn-sm btn-danger detail"><i class="fe-trash"></i> Hapus</button>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mt-4">
                                        ...
                                        <input type="date" name="tanggal" id="tangal" class="form-control" value="<?= $get_informasi['tanggal'] ?>">
                                    </div>
                                </div>
                            ...
                            <?php foreach ($get_informasi_session as $g) : ?>
                                ...
                                <input type="hidden" name="informasi_id[]" value="<?= $get_informasi['parent_id'] ?>">
                            <?php endforeach; ?>
                            <?= form_close() ?>
    ...
    <script>
        $('.idjadwal').on('click', function(e) {
            ...
            var parent = '<?= $get_informasi['parent_id'] ?>';

            $.ajax({
                url: "<?= base_url('informasi/tambah_detail') ?>",
                type: 'post',
                data: {
                    idjadwal: idjadwal,
                    parent: parent
                ...
                success: function() {
                    document.location.href = "<?= base_url('informasi/edit/') ?>" + btoa('<?= $get_informasi['parent_id'] ?>');
                }
            })
        })
        ...
        $('.detail').on('click', function(e) {
            ...
            $.ajax({
                url: "<?= base_url('informasi/hapus_informasi_detail') ?>",
                type: 'post',
                data: {
