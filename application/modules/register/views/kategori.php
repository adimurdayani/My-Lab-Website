                ...
                <div class="col-7">
                    <div class="card">
                        <div class="card-body table-responsive">
                            ...
                            <p class="sub-header">
                                Pada tabel di bawah, anda harus menambahkan kategori lab dengan cara klik <code>kolom pada tabel kosong, kemudian isi nama kategori lab</code> dengan catatan nama kategori lab tidak boleh dikosongkan.
                                <br>
                                Jika anda ingin mengedit data, anda harus klik <code>kolom pada tabel kemudian isi kategori lab</code> dengan catatan kategori lab dan keterangan tidak boleh dikosongkan.
                            </p>
...
<script language="JavaScript" type="text/javascript">
    ...
    jQuery(document).ready(function() {
        ...
        function load_data() {
            $.ajax({
                url: "<?= base_url(); ?>register/kategori/load_data",
                dataType: "JSON",
        ...
        $(document).on('click', '#btn_add', function() {
            ...
            $.ajax({
                url: "<?= base_url(); ?>register/kategori/tambah",
                method: 'POST',
        ...
        $(document).on('blur', '.table_data', function() {
            ...
            $.ajax({
                url: "<?= base_url(); ?>register/kategori/update",
                method: "POST",
                data: {
                    id: id,
        ...
        $(document).on('click', '.btn_delete', function(e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "<?= base_url(); ?>register/kategori/delete",
                        method: "POST",
                        beforeSend: function() {
                            swal({
                                title: "Menunggu",
