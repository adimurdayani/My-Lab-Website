    ...
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-8">
                    <div class="card">
                        <form action="<?= base_url('nilai/nilai_hard/hapus_all/') ?>" method="POST" id="form-delete">
                            <div class="row p-2">
                                <div class="col-md-6">
                            ...
                            <div class="card-body table-responsive">
                                ...
                                <table id="basic-datatable" class="table nowrap w-100">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($get_nilai_hard as $data) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?= base_url('nilai/nilai_hard/hapus/') . base64_encode($data->id) ?>" class="btn btn-outline-danger hapus" title="Hapus nilai" data-plugin="tippy" data-tippy-placement="top"><i class="fe-trash"></i> </a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Tambah Nilai Hardware</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    </div>
                    <?php echo form_open("nilai/nilai_hard/tambah"); ?>
        ...
        <!-- edit modal -->
        <?php foreach ($get_nilai_hard as $edit) : ?>
            <div id="edit<?= $edit->id ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Edit Nilai Hardware</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        </div>
                        <?php echo form_open("nilai/nilai_hard/edit"); ?>
                        <div class="modal-body p-4">
        ...
        <!-- edit modal -->
        <?php foreach ($get_nilai_hard as $detail) : ?>
